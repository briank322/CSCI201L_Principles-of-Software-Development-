...
<a id = "worm" href='Loggedinhomepage.jsp'>
...
if(check_Login()!= null){
	console.log("Im in!");
	document.getElementById("bookworm").setAttribute ("href", "Loggedinhomepage.jsp");
} */
	...
	xhr.onreadystatechange = function() {
		...
		if(this.readyState == this.DONE) {
			if(xhr.status == 200) {
				...
				window.location.replace("Loggedinhomepage.jsp");
				}
		}
	}
